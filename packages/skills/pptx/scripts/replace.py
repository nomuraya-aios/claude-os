...
Usage:
    uv run --python 3.11 replace.py <input.pptx> <replacements.json> <output.pptx>
...
def apply_replacements(pptx_file: str, json_file: str, output_file: str):
    ...
    if errors:
        ...
        print(
            "You can regenerate the inventory with: uv run --python 3.11 inventory.py <input.pptx> <output.json>"
        )
