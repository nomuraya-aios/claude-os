...
Usage:
    uv run --python 3.11 inventory.py input.pptx output.json
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  uv run --python 3.11 inventory.py presentation.pptx inventory.json
    Extracts text inventory with correct absolute positions for grouped shapes

  uv run --python 3.11 inventory.py presentation.pptx inventory.json --issues-only
