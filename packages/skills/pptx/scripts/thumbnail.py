...
Usage:
    uv run --python 3.11 thumbnail.py input.pptx [output_prefix] [--cols N] [--outline-placeholders]

Examples:
    uv run --python 3.11 thumbnail.py presentation.pptx
    # Creates: thumbnails.jpg (using default prefix)
    # Outputs:
    #   Created 1 grid(s):
    #     - thumbnails.jpg

    uv run --python 3.11 thumbnail.py large-deck.pptx grid --cols 4
    ...
    uv run --python 3.11 thumbnail.py template.pptx analysis --outline-placeholders
